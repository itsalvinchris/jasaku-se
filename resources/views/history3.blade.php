    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="#testimony">About Us</a>
          </li>
          <li class="nav-item">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="text-center">
              <img src="./images/iron-man.jpg" class="payment-image" alt="...">
              
              <form id="payment-modal" class="payment-modal" action="{{url("history/")}}" method="POST" enctype="multipart/form-data">
                @csrf
