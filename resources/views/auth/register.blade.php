              ...
              <div class="col main-kanan">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group row padding-add">
                        <div class="col-sm-10">
                        <input type="text"class="form-control-plaintext" id="inputName" placeholder="Name" name="name" value="{{ old('name') }}" required autofocus>
                        <div class="line"></div>
                            @if ($errors->has('name'))
                    ...
                    <div class="form-group row padding-add">
                        <div class="col-sm-10">
                        <input type="email"class="form-control-plaintext" id="staticEmail" placeholder="Email" name="email" value="{{ old('email') }}" required>
                    ...
                    <div class="form-group row padding-add">
                        <div class="col-sm-10">
                        <input type="password" class="form-control-plaintext" id="password" placeholder="Password" name="password" required>
                        <div class="line"></div>
                    ...
                    <div class="form-group row padding-add">
                        <div class="col-sm-10">
                        <input type="password" class="form-control-plaintext" id="password-confirm" placeholder="Confirm Password" name="password_confirmation" required>
                        <div class="line"></div>
                      </div>
                    </div>
